...
(defexternal-internet outside ("128.55.12.0" "255.255.0.0"))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;
;;; There is only one enclave which we'll call the victim-enclave
;;; and its a class B
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(defsite victim-enclave "128.55.12.0" "255.255.255.0"
	 :enterprise victim)

(defsubnet victim-subnet switched-subnet "128.55.12.0" "255.255.255.0")

;;; There are 5 machines in the enclave all distinct
;;; so no ensembles

;;; The typical worker computer is a "windows" computer
;;; It is a typical meember of the worker-machines ensemble
(defcomputer cadets unix-computer
  :ip-address-string "128.55.12.167"
  :typical nil
